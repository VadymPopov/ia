...
export default function Waiver() {
    ...
    <p>IMPORTANT NOTICE: BY SIGNING THIS TATTOO WAIVER FORM, YOU ARE WAIVING IMPORTANT LEGAL RIGHTS. READ THIS DOCUMENT CAREFULLY AND SEEK LEGAL COUNSEL IF NECESSARY BEFORE SIGNING.</p>
