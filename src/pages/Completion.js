...
export default function Succeeded() {
  ...
  return (
    <Container>
      ...
      <Text>
        Thank you for choosing my services. I look forward to our meeting! You
        will receive a booking confirmation by email. If you have any questions
        or need to make changes, please don't hesitate to contact me.
      </Text>
    </Container>
  );
}
