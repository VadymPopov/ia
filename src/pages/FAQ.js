        ...
        <Section primary={"primary"}>
             ...
             <List>
                <Item>
                    ...
                    <Text primary={"primary"} main={"main"}>To schedule an appointment, simply visit the <LinkTo to='/booking/service'>booking</LinkTo> page and follow the easy steps to select a suitable date and time. For your convenience, I also accept same-day appointments, provided you already have your design ready. Let's get started and make your appointment today! Let the magic begin!</Text>

                <Question>
                    Should I prepare for getting a tattoo?
                    </Question>
                    <Text primary={"primary"}>
                    Prior to your appointment, please refrain from consuming alcohol. Ensure that you eat and hydrate adequately beforehand. Avoid applying lotions to your skin, as we prefer clean, dry skin for the best tattooing experience.
                    </Text>
                </Item>
                ...
                <Item>
                    ...
                    <Text primary={"primary"}>
                    The longevity of a tattoo varies depending on factors such as skin type, location, ink quality, and aftercare. Generally, tattoos are considered permanent, but they may fade slightly over time. With proper <LinkTo to='/aftercare'>care</LinkTo> and sun protection, a well-done tattoo can last for many years. However, some fading is natural over the long term.
                    </Text>
                </Item>
                ...
                <Item>
                    ...
                    <Text primary={"primary"}>
                    Our cancellation policy emphasizes that the tattoo deposit is non-refundable. If you wish to reschedule your appointment, we kindly request at least 1 week's notice. Failing to provide adequate notice will require purchasing a new deposit for the rescheduled appointment. We appreciate your understanding and respect for others' time, as someone else could have booked the slot you initially reserved.
                    </Text>
                </Item>
                ...
                <Item>
                    ...
                    <Text primary={"primary"}>
                    Finger tattoos and inner-lip tattoos are possible, but they tend to have poor healing outcomes. Fingers have non-porous skin and experience constant movement and wear, leading to the ink spreading or fading over time. Similarly, the nature of tissue in the inner lip makes it challenging for tattoos to heal well, as it's constantly rubbing against teeth and remains wet. Therefore, I cannot guarantee the final quality of these tattoos, and any touch-ups will be at your expense.
                    </Text>
                </Item>
             </List>
    </Section>
