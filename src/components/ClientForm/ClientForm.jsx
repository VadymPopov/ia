...
import { InputContainer, Input, InputLabel, FlexContainer, Legend, FieldSet, Text } from "../WaiverForm/WaiverForm.styled";
import { useNavigate } from "react-router-dom";
  ...
  return (
      ...
      <FieldSet>
            ...
            <FlexContainer> 
            <InputContainer>
            <InputLabel htmlFor="sketch">Please upload a photo</InputLabel>
              <FileInput
              type="file"
              id="sketch"
              name="sketch"
           ...
           {selectedImageURL && <ImgPreview src={selectedImageURL}
            alt='client-sketch'/>}
