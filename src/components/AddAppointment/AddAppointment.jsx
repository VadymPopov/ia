...
import { FormWrapper, InputContainer, Input, CustomDatePicker, InputLabel, FlexContainer, StyledSelect, Legend, FieldSet } from "../WaiverForm/WaiverForm.styled";
    ...
    return (
      ...
      > 
         ...
         <InputContainer>
          ...
          <InputLabel>What service are you receiving ?</InputLabel>
              <Field name="service" as={StyledSelect}>
                <option value="small-tattoo" selected>Small Tattoo</option>
       ...
       <FlexContainer>
        ...
        {isValid && <Button type="submit" disabled={isProcessing}>{isProcessing ? (<>Processing<Loader/></>) : 'Submit'}
        </Button>}
        </FormWrapper>)}
      </Formik>
    );
